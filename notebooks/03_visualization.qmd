...
ggsave(here('outputs/figures/montealban_density_v2.png'), width = 6, height =5, bg = 'white')
```
...
ma_samp <- readxl::read_excel(here('Monte_Alban_Test_Individuals.xlsx')) |>
  ...
  mutate(actual_se = sd / 100 * Sr, # convert % SE to actual SE
         type = factor(type, levels = c('femur', 'enamel'))) 


# Get model IQR prediction ranges
set.seed(42)
